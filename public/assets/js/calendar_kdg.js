...
var _Calendar=function(){
    var _Calendar={
        ...
        lcs:function(ielem){
            ...
            if (isdt&(curdtarr.length==3)){
                ...
                _Calendar.ccy=curdtarr[0];
                _Calendar.prepcalendar(curdtarr[2],curdtarr[1]-1,curdtarr[0]);
            }
        ...
        addnull:function(d,m,y){
            ...
            return y+'-'+m0+m+'-'+''+d0+d; //формат возвращаемой даты
            //''+d0+d+'.'+m0+m+'.'+y;
    ...
    document.write('<table id="fc" style="position:absolute;border-collapse:collapse;background:#FFFFFF;border:1px solid #303030;display:none;-moz-user-select:none;-khtml-user-select:none;user-select:none;z-index: 1" cellpadding=2>');
    ...
    document.write('<tr style="background:#bebfc3;font:12px Arial;color:#FFFFFF"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>');
    ...
    document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#ece9f0" onclick="_Calendar.today()">Сегодня: '+_Calendar.addnull(_Calendar.sccd,_Calendar.sccm+1,_Calendar.sccy)+'</td></tr>');
